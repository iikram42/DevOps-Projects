...
## 🚀 Application Source Code for this Project

[![DevOps-Project-24: DotNet Monitoring](https://img.shields.io/badge/Project-DotNet%20Monitoring-brightgreen)](https://github.com/ikramkirmani/DevOps-Projects/tree/master/DevOps-Project-24/DotNet-monitoring)

![Pipeline Banner](https://miro.medium.com/v2/resize:fit:700/0*lhbz9vRWnbRl4xVS)

---

This project demonstrates a complete Real-Time **DevSecOps CI/CD Pipeline** for a `.NET` based web application. It mirrors a real-world enterprise-grade use case adopted by modern engineering teams.
...
💡 **Pipeline Highlights**:
- Clean and isolate Jenkins workspace
- Clone source code from Git
- Perform code quality analysis via SonarQube
- Implement quality gate checks before proceeding
- Scan for filesystem vulnerabilities using Trivy
- Perform OWASP dependency scanning
- Build and tag Docker image
- Push Docker image to registry
- Deploy on Docker container and Kubernetes cluster
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout From Git') {
            steps {
                git branch: 'master', url: 'https://github.com/iikram42/DevOps-Projects.git'
            }
        }
        ...
        stage("Trivy Image Scan") {
            steps {
                sh "trivy image iikram42/dotnet-monitoring:latest > trivy.txt"
            }
        }
        ...
        stage("Deploy to Container") {
            steps {
                sh "docker run -d --name dotnet -p 5000:5000 iikram42/dotnet-monitoring:latest"
            }
        }
        ...
        stage("Deploy to Kubernetes") {
            steps {
                dir('K8S') {
                    withKubeConfig(
                        credentialsId: 'k8s',
                        contextName: '',        // <-- Fill in your context
